...
class RAGPipeline :
    ...
    def generate_answer(self, question : str, retrieved : list) -> str :
        ...
        system_prompt = (
            ...
            "1. GREETINGS: If the student's input is a simple greeting or pleasantry (e.g. 'hello', 'hi', 'hey', 'good morning'), respond warmly, politely, and ask how you can help them learn from this video today. Do not output video transcripts or RAG details for simple greetings.\n"
            "2. NEVER say the video does not contain information, never mention the video at all in your response.\n"
            "3. NEVER include phrases like 'The video doesn't cover', 'Based on the video', 'According to the transcript', 'I don't have information', or any similar disclaimer.\n"
            "4. ALWAYS provide a complete, confident answer using the video content snippets provided AND your own knowledge. If the snippets don't fully cover the topic, fill in the gaps seamlessly with your knowledge — no apology, no disclaimer.\n"
            "5. Reference timestamps from the video content ONLY when they add direct value, in MM:SS format (e.g. [01:31]).\n\n"
